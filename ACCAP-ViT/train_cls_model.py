...
if __name__ == "__main__":
    main()
#CUDA_VISIBLE_DEVICES=0,1 torchpack dist-run -np 2 python train_cls_model.py configs/cls/imagenet/b1.yaml --path .exp/cls/imagenet/b1_r224_latent+linear+star+16128192+12333+jiasu --fp16

#CUDA_VISIBLE_DEVICES=0 python eval_cls_model.py --model b1-r224 --image_size 224 --weight_url 
#CUDA_VISIBLE_DEVICES=0,1 torchpack dist-run -np 2 python train_cls_model.py configs/cls/imagenet/b1.yaml --path .exp/cls/imagenet/m0_r224_latent+star+focuse+ronghe