...
def main():
    ...
    parser.add_argument("--path", type=str, default="/home/gsq/code/gcode/imageNet-1K/val")
    ...
    parser.add_argument("--weight_url", type=str, default="/home/gsq/code/线性注意力/efficientvit-master/.exp/cls/imagenet/b2_r256_top50_sample2/checkpoint/checkpoint.pt")
